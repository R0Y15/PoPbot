...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 left-1/2 -translate-x-1/2 z-[9999] flex max-h-screen w-[calc(100%-2rem)] flex-col sm:bottom-0 sm:top-auto sm:right-0 sm:left-auto sm:translate-x-0 sm:z-[100] sm:w-full sm:max-w-[420px] p-4",
      className
    )}
    {...props}
  />
